export default function Hero() {
    return (
        <section id="Hero" className="bg-[#09200D] w-full min-h-screen ">
            <div className=" flex flex-col lg:py-30 py-25 justify-center items-center">
                ...
                <div className="mt-8 flex justify-center items-center text-center px-4">
                    ...
                    <h1 className="text-[#EFECE2] font-extrabold tracking-tight leading-[1.07] text-[55px] sm:text-6xl md:text-7xl lg:text-[88px]">
                ...
                <div className="">
                    <p className="text-[#ABAFA2] text-center lg:text-[20px] text-[12px] mt-5">Rent9ja connects landlords and tenants directly — zero agent <br /> fees, verified listings, and secure payments in Naira or crypto</p>
                </div>
                
                <div className="flex lg:flex-row justify-center items-center flex-col pt-10 gap-5">
                    
                        <a href='#Contact' className='bg-[#C9F967] flex gap-1 items-center py-4 px-6 text-[14px] rounded-full text-black transform transition-transform hover:-translate-y-0.5 duration-300 ease-in-out'>List your Property
                        <svg 
